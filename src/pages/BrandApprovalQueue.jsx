  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Coda Approvazioni Brand</h1>
      ...
      {pendingThemes.length === 0 ? (
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Tutto Completato!</h2>
          <p className="text-gray-500">Nessuna richiesta di approvazione brand in sospeso</p>
        </div>
      ) : (
            ...
            {pendingThemes.map(theme => (
              ...
              >
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-500">Inviato da {theme.submitted_by}</span>
            ...
            {selectedTheme ? (
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <span className="text-sm text-gray-500">Inviato</span>
                  ...
                  {selectedTheme.changes && (
                    <div className="p-3 bg-blue-50 rounded-lg">
                      <p className="text-xs font-semibold text-blue-700 mb-2">Modifiche:</p>
              ...
              <div className="text-center text-gray-400 py-12">
                ...
                <p>Seleziona un tema da revisionare</p>
              </div>
            )}
          </div>
        </div>
