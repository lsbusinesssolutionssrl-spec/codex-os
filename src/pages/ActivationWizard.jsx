    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="text-center">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Activation Wizard</h1>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-3">
          <span className="text-sm font-medium text-gray-700">Activation Progress</span>
        ...
        {progress === 100 && (
          <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center gap-2">
            ...
            <p className="text-sm font-medium text-green-800">Tenant fully activated! All systems operational.</p>
          </div>
        )}
      </div>
